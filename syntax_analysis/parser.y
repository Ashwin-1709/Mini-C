...
%type  s main_func functional_declaration P var_type func_type
%type  func_declarator param_list declare_var
%type  compound_statement statement_list single_statement switch_statment
%type  for_statement if_statement while_statement declaration jump_statement print_statement expr return_statement
