...
;
expression_statement : expression_statement OR_OP expression_statement  {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("||") , $3);printf("t%d := t%d||t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement AND_OP expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("&&") , $3);printf("t%d := t%d&&t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement GT_OP expression_statement  {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel(">") , $3);printf("t%d := t%d>t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
			          | expression_statement LT_OP expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("<") , $3);printf("t%d := t%d<t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement GE_OP expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel(">=") , $3);printf("t%d := t%d>=t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement LE_OP expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("<=") , $3);printf("t%d := t%d<=t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement PLUS expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("+") , $3);printf("t%d := t%d+t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement HYPHEN expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("-") , $3);printf("t%d := t%d-t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement STAR expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("*") , $3);printf("t%d := t%d*t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement SLASH expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("/") , $3);printf("t%d := t%d/t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
				      | expression_statement PERCENT expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("%") , $3);printf("t%d := t%d\%t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
                      | expression_statement EQ_OP expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("==") , $3);printf("t%d := t%d==t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
                      | expression_statement NE_OP expression_statement {$$ = passNode("expression_stmt" , 3 , $1 , createNodeByLabel("!=") , $3);printf("t%d := t%d!=t%d\n",temp_var,$<tIdx>1,$<tIdx>3);$<tIdx>$=temp_var++;}
